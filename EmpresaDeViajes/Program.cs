                                ...
                                switch (opcionTipoCliente.KeyChar) {
                                    ...
                                    nuevoParticular:
                                        ...
                                        if (liClientes.Count(x => x.Id == id) == 0) {
                                            ...
                                            cli = new Cliente(id, esParticular, nombre, apellido, edad, dni, nacionalidad, localidad, direccion, telefono);
                                            liClientes.Add(cli);
                                    ...
                                    nuevoCorporativo:
                                        ...
                                        if (liClientes.Count(x => x.Id == id) == 0) {
                                            ...
                                            Console.WriteLine("Paritular:"); // imprime "particular : false"
                                            esParticular = false;
